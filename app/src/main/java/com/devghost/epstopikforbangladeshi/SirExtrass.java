...
public class SirExtrass extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.fragment_sir_extrass, container, false);

        listView=view.findViewById(R.id.voca_words_only_list5);
        progressBar=view.findViewById(R.id.voca_words_only_progress5);
        ...
        String url = "https://sampledev007.000webhostapp.com/apps/sirextrass.json";
