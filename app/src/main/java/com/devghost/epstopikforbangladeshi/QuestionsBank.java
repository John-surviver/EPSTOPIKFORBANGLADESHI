...
public class QuestionsBank extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.fragment_questions_bank, container, false);

        listView=view.findViewById(R.id.voca_words_only_list4);
        progressBar=view.findViewById(R.id.voca_words_only_progress4);
        ...
        String url = "https://sampledev007.000webhostapp.com/apps/questionbank.json";
