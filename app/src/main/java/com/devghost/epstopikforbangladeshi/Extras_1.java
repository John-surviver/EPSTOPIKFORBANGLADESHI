...
public class Extras_1 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.fragment_extras_1, container, false);



        listView=view.findViewById(R.id.voca_words_only_list3);
        progressBar=view.findViewById(R.id.voca_words_only_progress3);
        ...
        String url = "https://sampledev007.000webhostapp.com/apps/extras1.json";
