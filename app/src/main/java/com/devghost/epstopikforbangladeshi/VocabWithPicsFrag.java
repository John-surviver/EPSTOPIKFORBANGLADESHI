...
public class VocabWithPicsFrag extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.fragment_vocab_with_pics, container, false);
    ...
    private void assignIds() {
        progressBar=view.findViewById(R.id.progress_pics_only);
        gridView =view.findViewById(R.id.pics_only_grid);
